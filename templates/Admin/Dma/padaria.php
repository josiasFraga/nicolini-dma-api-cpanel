		...
		<div class="card">
			<div class="card-header">
				...
				<div class="card-tools d-flex align-items-center">
					...
					<a href="<?= $this->Url->build(['action' => 'padaria']); ?>" class="btn btn-link btn-sm text-secondary">
						<i class="fa fa-times"></i> Limpar Filtros
					</a>
					<?php endif; ?>

					<!-- Link para Exportar com Filtros e Ordenação -->
					<a href="<?= $this->Url->build(['action' => 'exportPadaria', '?' => $filters]); ?>" class="btn btn-success btn-sm ml-2">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="filterForm" method="get" action="<?= $this->Url->build(['action' => 'padaria']); ?>">
					<!-- Campos de Filtro -->
...
<?php $this->Html->script('pages/dma_padaria', ['block' => true]); ?>