          ...
          <table class="table table-hover">
            <thead>
              <tr>
                  ...
                  <th scope="col"><?= $this->Paginator->sort('cutout_code') ?></th>
            ...
            <tbody>
              <?php foreach ($storeCutoutCodes as $storeCutoutCode): ?>
                <tr>
                  <td><?= $this->Number->format($storeCutoutCode->id) ?></td>
                  <td><?= h($storeCutoutCode->created) ?></td>
                  <td><?= h($storeCutoutCode->modified) ?></td>
                  <td><?= h($storeCutoutCode->store_code) ?></td>
                  <td><?= h($storeCutoutCode->cutout_code) ?></td>
                  <td><?= h($storeCutoutCode->cutout_type) ?></td>
                  <td class="actions text-right">
                      <?= $this->Html->link(__('View'), ['action' => 'view', $storeCutoutCode->id], ['class'=>'btn btn-info btn-xs']) ?>
