          ...
          <table class="table table-hover">
            ...
            <tbody>
              <?php foreach ($expectedYield as $expectedYield): ?>
                <tr>
                  <td class="text-center"><?= $this->Number->format($expectedYield->id) ?></td>
                  <td class="text-center"><?= h($expectedYield->store_code) ?></td>
                  <td class="text-center"><?= h($expectedYield->good_code) ?></td>
